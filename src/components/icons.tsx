 ...
 * Brand marks.
 *
 * lucide-react v1 removed brand icons, so GitHub and LinkedIn live here as
 * filled paths. The prop signature matches a lucide icon (`className`,
 * `strokeWidth`) so they are interchangeable in `site.ts` — `strokeWidth` is
 * accepted and ignored, since these are solid glyphs rather than line icons.
 */
